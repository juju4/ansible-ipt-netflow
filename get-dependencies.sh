...
#[ ! -e $rolesdir/juju4.ipt-netflow ] && ln -s ansible-ipt-netflow $rolesdir/juju4.ipt-netflow
[ ! -e $rolesdir/juju4.ipt-netflow ] && cp -R $rolesdir/ansible-ipt-netflow $rolesdir/juju4.ipt-netflow
